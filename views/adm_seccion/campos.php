        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="widget  widget-box box-container form-main widget-form-cart" id="form">
                    <form method="post" action="<?php echo $controlador->link_adm_campo_alta_bd; ?>" class="form-additional">
                        ...
                        <?php echo $controlador->inputs->adm_campo_descripcion; ?>
                        ...
                        <div class="controls">
                            <button type="submit" class="btn btn-success" value="campos" name="btn_action_next">Alta</button><br>
                        </div>
                    </form>
                </div>
            </div>
